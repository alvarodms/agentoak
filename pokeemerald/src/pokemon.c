...
static const u16 sSpeciesToHoennPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_HOENN(GLIGAR_HOENN),
    SPECIES_TO_HOENN(GLISCOR_HOENN),
};
...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_NATIONAL(GLIGAR_HOENN),
    SPECIES_TO_NATIONAL(GLISCOR_HOENN),
};
...
static const u16 sHoennToNationalOrder[NUM_SPECIES - 1] =
{
    ...
    HOENN_TO_NATIONAL(CORSOLA_HOENN),
    HOENN_TO_NATIONAL(GROWLITHE_HOENN),
    HOENN_TO_NATIONAL(ARCANINE_HOENN),
    ...
    HOENN_TO_NATIONAL(GLIGAR_HOENN),
    HOENN_TO_NATIONAL(GLISCOR_HOENN),
...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_WEAVILE - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GIBLE - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GABITE - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GARCHOMP - 1]    = ANIM_V_SHAKE,
    ...
    [SPECIES_GLIGAR_HOENN - 1] = ANIM_V_STRETCH,
    [SPECIES_GLISCOR_HOENN - 1] = ANIM_V_STRETCH,
};
...
s32 CalculateBaseDamage(struct BattlePokemon *attacker, struct BattlePokemon *defender, u32 move, u16 sideStatus, u16 powerOverride, u8 typeOverride, u8 battlerIdAtk, u8 battlerIdDef)
{
    ...
    /* Weather effects apply based on move TYPE, not category */
    ...
    /* Flash fire boosts all Fire moves regardless of category */
