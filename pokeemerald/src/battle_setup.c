...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_SIDNEY] = REMATCH(TRAINER_SIDNEY, TRAINER_SIDNEY_REMATCH_1, TRAINER_SIDNEY_REMATCH_2, TRAINER_SIDNEY_REMATCH_3, TRAINER_SIDNEY_REMATCH_4, MAP_EVER_GRANDE_CITY),
    [REMATCH_PHOEBE] = REMATCH(TRAINER_PHOEBE, TRAINER_PHOEBE_REMATCH_1, TRAINER_PHOEBE_REMATCH_2, TRAINER_PHOEBE_REMATCH_3, TRAINER_PHOEBE_REMATCH_4, MAP_EVER_GRANDE_CITY),
    [REMATCH_GLACIA] = REMATCH(TRAINER_GLACIA, TRAINER_GLACIA_REMATCH_1, TRAINER_GLACIA_REMATCH_2, TRAINER_GLACIA_REMATCH_3, TRAINER_GLACIA_REMATCH_4, MAP_EVER_GRANDE_CITY),
    [REMATCH_DRAKE] = REMATCH(TRAINER_DRAKE, TRAINER_DRAKE_REMATCH_1, TRAINER_DRAKE_REMATCH_2, TRAINER_DRAKE_REMATCH_3, TRAINER_DRAKE_REMATCH_4, MAP_EVER_GRANDE_CITY),
    [REMATCH_WALLACE] = REMATCH(TRAINER_WALLACE, TRAINER_WALLACE_REMATCH_1, TRAINER_WALLACE_REMATCH_2, TRAINER_WALLACE_REMATCH_3, TRAINER_WALLACE_REMATCH_4, MAP_EVER_GRANDE_CITY),
};
