...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_CORSOLA_HOENN] = gMonIcon_CorsolaHoenn,
    [SPECIES_GROWLITHE_HOENN] = gMonIcon_GrowlitheHoenn,
    ...
    [SPECIES_BAGON_HOENN] = gMonIcon_BagonHoenn,
    ...
    [SPECIES_PINSIR_HOENN] = gMonIcon_PinsirHoenn,
    [SPECIES_STANTLER_HOENN] = gMonIcon_StantlerHoenn,
    [SPECIES_GLIGAR_HOENN] = gMonIcon_GligarHoenn,
    [SPECIES_GLISCOR_HOENN] = gMonIcon_GliscorHoenn,
    [SPECIES_DEOXYS_HOENN] = gMonIcon_DeoxysHoenn,
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_GABITE] = 2,
    [SPECIES_GARCHOMP] = 1,
    [SPECIES_CORSOLA_HOENN] = 0,
    [SPECIES_GROWLITHE_HOENN] = 0,
    [SPECIES_ARCANINE_HOENN] = 0,
    [SPECIES_DUSKNOIR] = 0,
    [SPECIES_HONCHKROW] = 0,
    [SPECIES_FROSLASS] = 0,
    [SPECIES_MAMOSWINE] = 0,
    [SPECIES_BAGON_HOENN] = 0,
    [SPECIES_VULPIX_HOENN] = 0,
    [SPECIES_NINETALES_HOENN] = 0,
    [SPECIES_FARIGIRAF] = 0,
    [SPECIES_PINSIR_HOENN] = 0,
    [SPECIES_STANTLER_HOENN] = 0,
    [SPECIES_GLIGAR_HOENN] = 0,
    [SPECIES_GLISCOR_HOENN] = 0,
    [SPECIES_DEOXYS_HOENN] = 0,
    [SPECIES_EGG] = 1,
    [SPECIES_UNOWN_B] = 0,
    [SPECIES_UNOWN_C] = 0,
    [SPECIES_UNOWN_D] = 0,
