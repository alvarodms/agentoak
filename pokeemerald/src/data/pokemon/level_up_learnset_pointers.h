const u16 *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_GROWLITHE_HOENN] = sGrowlitheHoennLevelUpLearnset,
    ...
    [SPECIES_GLIGAR_HOENN] = sGligarHoennLevelUpLearnset,
    [SPECIES_GLISCOR_HOENN] = sGliscorHoennLevelUpLearnset,
    [SPECIES_DEOXYS_HOENN] = sDeoxysHoennLevelUpLearnset,
    [SPECIES_LOTAD_HOENN] = sLotadHoennLevelUpLearnset,
    [SPECIES_LOMBRE_HOENN] = sLombreHoennLevelUpLearnset,
    [SPECIES_LUDICOLO_HOENN] = sLudicoloHoennLevelUpLearnset,
    [SPECIES_BRELOOM_HOENN] = sBreloomHoennLevelUpLearnset,
    [SPECIES_FROSLASS] = sFroslassLevelUpLearnset,
    [SPECIES_MAMOSWINE] = sMamoswineLevelUpLearnset,
    [SPECIES_SHROOMISH_HOENN] = sShroomishHoennLevelUpLearnset,
    [SPECIES_TREECKO_HOENN] = sTreeckoHoennLevelUpLearnset,
    [SPECIES_GROVYLE_HOENN] = sGrovyleHoennLevelUpLearnset,
    [SPECIES_SCEPTILE_HOENN] = sSceptileHoennLevelUpLearnset,
    [SPECIES_TORCHIC_HOENN] = sTorchicHoennLevelUpLearnset,
    [SPECIES_COMBUSKEN_HOENN] = sCombuskenHoennLevelUpLearnset,
    [SPECIES_BLAZIKEN_HOENN] = sBlazikenHoennLevelUpLearnset,
    [SPECIES_MUDKIP_HOENN] = sMudkipHoennLevelUpLearnset,
    [SPECIES_MARSHTOMP_HOENN] = sMarshtompHoennLevelUpLearnset,
    [SPECIES_SWAMPERT_HOENN] = sSwampertHoennLevelUpLearnset,
};
