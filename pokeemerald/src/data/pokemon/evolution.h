const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    // [SPECIES_VULPIX_HOENN] — removed: species not yet registered (see tech-debt-backlog)
    ...
    [SPECIES_SNEASEL]    = {{EVO_LEVEL, 40, SPECIES_WEAVILE}},
    [SPECIES_MURKROW]    = {{EVO_LEVEL, 37, SPECIES_HONCHKROW}},
    ...
    // [SPECIES_GIRAFARIG] -> SPECIES_FARIGIRAF — removed: species not yet registered (see tech-debt-backlog)
};
