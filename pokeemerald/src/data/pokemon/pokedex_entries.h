const struct PokedexEntry gPokedexEntries[] =
{
    ...
    [NATIONAL_DEX_GLISCOR_HOENN] =
    {
        .categoryName = _("Fang Scorp"),
        .height = 20,
        .weight = 425,
        .description = gGliscorHoennPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_LOTAD_HOENN] =
    {
        ...
        .height = 5,
        .weight = 26,
        .description = gLotadHoennPokedexText,
        .pokemonScale = 406,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SHROOMISH_HOENN] =
    {
        .categoryName = _("Frost Spore"),
        .height = 4,
        .weight = 45,
        .description = gShroomishHoennPokedexText,
        .pokemonScale = 536,
        .pokemonOffset = 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_LOMBRE_HOENN] =
    {
        .categoryName = _("Conductor"),
        .height = 12,
        .weight = 325,
        .description = gLombreHoennPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 6,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_BRELOOM_HOENN] =
    {
        .categoryName = _("Frostfist"),
        .height = 12,
        .weight = 392,
        .description = gBreloomHoennPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 6,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_LUDICOLO_HOENN] =
    {
        .categoryName = _("STORMDANCER"),
        .height = 15,
        .weight = 550,
        .description = gLudicoloHoennPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
