const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_DAZZLING_GLEAM] = _("DAZZLNGLEAM"),
    ...
    [MOVE_CLOSE_COMBAT] = _("CLOSECOMBAT"),
    [MOVE_AQUA_TAIL] = _("AQUA TAIL"),
    [MOVE_AURA_SPHERE] = _("AURA SPHERE"),
    [MOVE_SUCKER_PUNCH] = _("SUCKERPUNCH"),
    ...
    [MOVE_FLASH_CANNON] = _("FLASHCANNON"),
    [MOVE_NASTY_PLOT] = _("NASTY PLOT"),
    [MOVE_CROSS_POISON] = _("CROSSPOISON"),
    [MOVE_IRON_HEAD] = _("IRON HEAD"),
    [MOVE_ZEN_HEADBUTT] = _("ZENHEADBUTT"),
    [MOVE_SPORE_FIST] = _("SPORE FIST"),
    [MOVE_TIDAL_FLARE] = _("TIDAL FLARE"),
    [MOVE_IRON_LEAF] = _("IRON LEAF"),
};
