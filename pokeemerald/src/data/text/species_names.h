const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_CORSOLA_HOENN] = _("CORSOLA"),
    [SPECIES_GROWLITHE_HOENN] = _("GROWLITHE"),
    [SPECIES_ARCANINE_HOENN] = _("ARCANINE"),
    [SPECIES_STANTLER_HOENN] = _("STANTLER"),
    [SPECIES_DUSKNOIR] = _("DUSKNOIR"),
    [SPECIES_HONCHKROW] = _("HONCHKROW"),
    [SPECIES_FROSLASS] = _("FROSLASS"),
    [SPECIES_MAMOSWINE] = _("MAMOSWINE"),
    [SPECIES_BAGON_HOENN] = _("BAGON"),
    [SPECIES_VULPIX_HOENN] = _("VULPIX"),
    [SPECIES_NINETALES_HOENN] = _("NINETALES"),
    [SPECIES_FARIGIRAF] = _("FARIGIRAF"),
    [SPECIES_PINSIR_HOENN] = _("PINSIR"),
    [SPECIES_DEOXYS_HOENN] = _("DEOXYS"),
    [SPECIES_GLIGAR_HOENN] = _("GLIGAR"),
    [SPECIES_GLISCOR_HOENN] = _("GLISCOR"),
    [SPECIES_LOTAD_HOENN] = _("LOTAD"),
    [SPECIES_SHROOMISH_HOENN] = _("SHROOMISH"),
    [SPECIES_LOMBRE_HOENN] = _("LOMBRE"),
    [SPECIES_BRELOOM_HOENN] = _("BRELOOM"),
    [SPECIES_LUDICOLO_HOENN] = _("LUDICOLO"),
    [SPECIES_TREECKO_HOENN] = _("TREECKO"),
    [SPECIES_GROVYLE_HOENN] = _("GROVYLE"),
    [SPECIES_SCEPTILE_HOENN] = _("SCEPTILE"),
    [SPECIES_TORCHIC_HOENN] = _("TORCHIC"),
    [SPECIES_COMBUSKEN_HOENN] = _("COMBUSKEN"),
    [SPECIES_BLAZIKEN_HOENN] = _("BLAZIKEN"),
    [SPECIES_MUDKIP_HOENN] = _("MUDKIP"),
    [SPECIES_MARSHTOMP_HOENN] = _("MARSHTOMP"),
    [SPECIES_SWAMPERT_HOENN] = _("SWAMPERT"),
