...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    ...
    .heldItem = ITEM_MAGNET,
    .moves = {MOVE_THUNDERBOLT, MOVE_GIGA_DRAIN, MOVE_THUNDER_WAVE, MOVE_RAIN_DANCE}
    },
    {
    .iv = 255,
    .lvl = 54,
    ...
    .heldItem = ITEM_NEVER_MELT_ICE,
    .moves = {MOVE_ICE_BEAM, MOVE_MOONBLAST, MOVE_SHADOW_BALL, MOVE_CALM_MIND}
    },
    {
    .iv = 255,
    .lvl = 55,
...
static const struct TrainerMonItemCustomMoves sParty_BrendanRoute110Mudkip[] = {
    ...
    .species = SPECIES_LOTAD_HOENN,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_THUNDER_SHOCK, MOVE_ABSORB, MOVE_CHARGE, MOVE_GROWL}
    },
    {
    .iv = 100,
    .lvl = 20,
...
static const struct TrainerMonItemCustomMoves sParty_BrendanLilycoveMudkip[] = {
    ...
    .heldItem = ITEM_MAGNET,
    .moves = {MOVE_SHOCK_WAVE, MOVE_MEGA_DRAIN, MOVE_THUNDER_WAVE, MOVE_FAKE_OUT}
    },
    {
    .iv = 150,
    .lvl = 34,
    .species = SPECIES_PINSIR_HOENN,
    .heldItem = ITEM_CHARCOAL,
    .moves = {MOVE_X_SCISSOR, MOVE_FLAME_WHEEL, MOVE_BRICK_BREAK, MOVE_FOCUS_ENERGY}
    },
    {
    .iv = 200,
    .lvl = 36,
...
static const struct TrainerMonItemCustomMoves sParty_BrendanPostgameTorchic[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_BULK_UP, MOVE_BRICK_BREAK, MOVE_EARTHQUAKE, MOVE_WATERFALL}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan4[] = {
    ...
    .species = SPECIES_KINGDRA,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_RAIN_DANCE, MOVE_HYDRO_PUMP, MOVE_ICE_BEAM, MOVE_DRAGON_PULSE}
    }
};
