const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(CORSOLA_HOENN, gMonPalette_CorsolaHoenn),
    SPECIES_PAL(GROWLITHE_HOENN, gMonPalette_GrowlitheHoenn),
    SPECIES_PAL(ARCANINE_HOENN, gMonPalette_ArcanineHoenn),
    SPECIES_PAL(DUSKNOIR, gMonPalette_Dusknoir),
    SPECIES_PAL(HONCHKROW, gMonPalette_Honchkrow),
    SPECIES_PAL(BAGON_HOENN, gMonPalette_BagonHoenn),
    ...
    SPECIES_PAL(PINSIR_HOENN, gMonPalette_PinsirHoenn),
    SPECIES_PAL(STANTLER_HOENN, gMonPalette_StantlerHoenn),
    SPECIES_PAL(GLIGAR_HOENN, gMonPalette_GligarHoenn),
    SPECIES_PAL(GLISCOR_HOENN, gMonPalette_GliscorHoenn),
    SPECIES_PAL(SHROOMISH_HOENN, gMonPalette_ShroomishHoenn),
    SPECIES_PAL(LOTAD_HOENN, gMonPalette_LotadHoenn),
    SPECIES_PAL(LOMBRE_HOENN, gMonPalette_LombreHoenn),
    SPECIES_PAL(BRELOOM_HOENN, gMonPalette_BreloomHoenn),
    SPECIES_PAL(DEOXYS_HOENN, gMonPalette_DeoxysHoenn),
