const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(CORSOLA_HOENN, gMonFrontPic_CorsolaHoenn),
    SPECIES_SPRITE(GROWLITHE_HOENN, gMonFrontPic_GrowlitheHoenn),
    SPECIES_SPRITE(ARCANINE_HOENN, gMonFrontPic_ArcanineHoenn),
    SPECIES_SPRITE(DUSKNOIR, gMonFrontPic_Dusknoir),
    SPECIES_SPRITE(HONCHKROW, gMonFrontPic_Honchkrow),
    SPECIES_SPRITE(BAGON_HOENN, gMonFrontPic_BagonHoenn),
    ...
    SPECIES_SPRITE(PINSIR_HOENN, gMonFrontPic_PinsirHoenn),
    SPECIES_SPRITE(STANTLER_HOENN, gMonFrontPic_StantlerHoenn),
    SPECIES_SPRITE(GLIGAR_HOENN, gMonFrontPic_GligarHoenn),
    SPECIES_SPRITE(GLISCOR_HOENN, gMonFrontPic_GliscorHoenn),
    SPECIES_SPRITE(SHROOMISH_HOENN, gMonFrontPic_ShroomishHoenn),
    SPECIES_SPRITE(LOTAD_HOENN, gMonFrontPic_LotadHoenn),
    SPECIES_SPRITE(LOMBRE_HOENN, gMonFrontPic_LombreHoenn),
    SPECIES_SPRITE(BRELOOM_HOENN, gMonFrontPic_BreloomHoenn),
    SPECIES_SPRITE(DEOXYS_HOENN, gMonFrontPic_DeoxysHoenn),
