...
// Gen III
    ...
    SPECIES_SPRITE(CORSOLA_HOENN, gMonStillFrontPic_CorsolaHoenn),
    SPECIES_SPRITE(GROWLITHE_HOENN, gMonStillFrontPic_GrowlitheHoenn),
    SPECIES_SPRITE(ARCANINE_HOENN, gMonStillFrontPic_ArcanineHoenn),
    SPECIES_SPRITE(DUSKNOIR, gMonStillFrontPic_Dusknoir),
    SPECIES_SPRITE(HONCHKROW, gMonStillFrontPic_Honchkrow),
    SPECIES_SPRITE(BAGON_HOENN, gMonStillFrontPic_BagonHoenn),
    ...
    SPECIES_SPRITE(PINSIR_HOENN, gMonStillFrontPic_PinsirHoenn),
    SPECIES_SPRITE(STANTLER_HOENN, gMonStillFrontPic_StantlerHoenn),
    SPECIES_SPRITE(GLIGAR_HOENN, gMonStillFrontPic_GligarHoenn),
    SPECIES_SPRITE(DEOXYS_HOENN, gMonStillFrontPic_DeoxysHoenn),
    SPECIES_SPRITE(SHROOMISH_HOENN, gMonStillFrontPic_ShroomishHoenn),
    SPECIES_SPRITE(LOTAD_HOENN, gMonStillFrontPic_LotadHoenn),
    SPECIES_SPRITE(LOMBRE_HOENN, gMonStillFrontPic_LombreHoenn),
    SPECIES_SPRITE(BRELOOM_HOENN, gMonStillFrontPic_BreloomHoenn),
