const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(CORSOLA_HOENN, gMonBackPic_CorsolaHoenn),
    SPECIES_SPRITE(GROWLITHE_HOENN, gMonBackPic_GrowlitheHoenn),
    ...
    SPECIES_SPRITE(BAGON_HOENN, gMonBackPic_BagonHoenn),
    ...
    SPECIES_SPRITE(PINSIR_HOENN, gMonBackPic_PinsirHoenn),
    SPECIES_SPRITE(STANTLER_HOENN, gMonBackPic_StantlerHoenn),
    SPECIES_SPRITE(GLIGAR_HOENN, gMonBackPic_GligarHoenn),
    SPECIES_SPRITE(GLISCOR_HOENN, gMonBackPic_GliscorHoenn),
    SPECIES_SPRITE(SHROOMISH_HOENN, gMonBackPic_ShroomishHoenn),
    SPECIES_SPRITE(LOTAD_HOENN, gMonBackPic_LotadHoenn),
    SPECIES_SPRITE(LOMBRE_HOENN, gMonBackPic_LombreHoenn),
    SPECIES_SPRITE(BRELOOM_HOENN, gMonBackPic_BreloomHoenn),
    SPECIES_SPRITE(DEOXYS_HOENN, gMonBackPic_DeoxysHoenn),
