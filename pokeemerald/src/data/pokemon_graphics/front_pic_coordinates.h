...
const struct MonCoords gMonFrontPicCoords[] =
{
    ...
    [SPECIES_RIOLU]       = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 12 },
    [SPECIES_LUCARIO]     = { .size = MON_COORDS_SIZE(48, 64), .y_offset =  1 },
    ...
    [SPECIES_CORSOLA_HOENN] = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 12 },
    [SPECIES_GROWLITHE_HOENN] = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 10 },
    [SPECIES_ARCANINE_HOENN] = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 2 },
    [SPECIES_DUSKNOIR] = { .size = MON_COORDS_SIZE(56, 56), .y_offset = 5 },
    [SPECIES_HONCHKROW] = { .size = MON_COORDS_SIZE(56, 56), .y_offset = 6 },
    [SPECIES_BAGON_HOENN] = { .size = MON_COORDS_SIZE(32, 40), .y_offset = 13 },
    [SPECIES_VULPIX_HOENN] = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 9 },
    [SPECIES_NINETALES_HOENN] = { .size = MON_COORDS_SIZE(56, 56), .y_offset = 5 },
    [SPECIES_FARIGIRAF] = { .size = MON_COORDS_SIZE(56, 64), .y_offset = 2 },
    [SPECIES_PINSIR_HOENN] = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 8 },
    [SPECIES_STANTLER_HOENN] = { .size = MON_COORDS_SIZE(56, 56), .y_offset = 4 },
    [SPECIES_GLIGAR_HOENN] = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 8 },
    [SPECIES_GLISCOR_HOENN] = { .size = MON_COORDS_SIZE(56, 56), .y_offset = 0 },
    [SPECIES_SHROOMISH_HOENN] = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 14 },
    [SPECIES_LOTAD_HOENN]  = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 14 },
    [SPECIES_LOMBRE_HOENN] = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 10 },
    [SPECIES_BRELOOM_HOENN] = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 9 },
    [SPECIES_DEOXYS_HOENN] = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 0 },
