const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_GROWLITHE_HOENN] = gMonFootprint_GrowlitheHoenn,
    ...
    [SPECIES_SHROOMISH_HOENN] = gMonFootprint_ShroomishHoenn,
    [SPECIES_LOTAD_HOENN] = gMonFootprint_LotadHoenn,
    [SPECIES_LOMBRE_HOENN] = gMonFootprint_LombreHoenn,
    [SPECIES_BRELOOM_HOENN] = gMonFootprint_BreloomHoenn,
