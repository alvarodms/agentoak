...
const struct MonCoords gMonBackPicCoords[] =
{
    ...
    [SPECIES_RIOLU]       = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 11 },
    [SPECIES_LUCARIO]     = { .size = MON_COORDS_SIZE(48, 64), .y_offset =  3 },
    [SPECIES_WEAVILE]     = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  8 },
    [SPECIES_GIBLE]       = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 12 },
    [SPECIES_GABITE]      = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  8 },
    [SPECIES_GARCHOMP]    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  6 },
    [SPECIES_CORSOLA_HOENN] = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 12 },
    [SPECIES_GROWLITHE_HOENN] = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 8 },
    ...
    [SPECIES_VULPIX_HOENN] = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 9 },
    [SPECIES_NINETALES_HOENN] = { .size = MON_COORDS_SIZE(64, 56), .y_offset = 4 },
    [SPECIES_FARIGIRAF] = { .size = MON_COORDS_SIZE(64, 56), .y_offset = 4 },
    [SPECIES_PINSIR_HOENN] = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 9 },
    [SPECIES_STANTLER_HOENN] = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 7 },
    [SPECIES_GLIGAR_HOENN] = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 9 },
    [SPECIES_GLISCOR_HOENN] = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 8 },
    [SPECIES_SHROOMISH_HOENN] = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 14 },
    [SPECIES_LOTAD_HOENN]  = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 15 },
    [SPECIES_LOMBRE_HOENN] = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 9 },
    [SPECIES_BRELOOM_HOENN] = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 6 },
