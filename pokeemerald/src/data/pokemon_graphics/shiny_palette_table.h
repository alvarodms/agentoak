const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(CORSOLA_HOENN, gMonShinyPalette_CorsolaHoenn),
    SPECIES_SHINY_PAL(GROWLITHE_HOENN, gMonShinyPalette_GrowlitheHoenn),
    ...
    SPECIES_SHINY_PAL(BAGON_HOENN, gMonShinyPalette_BagonHoenn),
    ...
    SPECIES_SHINY_PAL(PINSIR_HOENN, gMonShinyPalette_PinsirHoenn),
    SPECIES_SHINY_PAL(STANTLER_HOENN, gMonShinyPalette_StantlerHoenn),
    SPECIES_SHINY_PAL(GLIGAR_HOENN, gMonShinyPalette_GligarHoenn),
    SPECIES_SHINY_PAL(GLISCOR_HOENN, gMonShinyPalette_GliscorHoenn),
    SPECIES_SHINY_PAL(SHROOMISH_HOENN, gMonShinyPalette_ShroomishHoenn),
    SPECIES_SHINY_PAL(LOTAD_HOENN, gMonShinyPalette_LotadHoenn),
    SPECIES_SHINY_PAL(LOMBRE_HOENN, gMonShinyPalette_LombreHoenn),
    SPECIES_SHINY_PAL(BRELOOM_HOENN, gMonShinyPalette_BreloomHoenn),
    SPECIES_SHINY_PAL(DEOXYS_HOENN, gMonShinyPalette_DeoxysHoenn),
