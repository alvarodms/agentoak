...
static const union AnimCmd sAnim_CorsolaHoenn_1[] =
{
    ANIMCMD_FRAME(0, 15),
    ANIMCMD_FRAME(1, 15),
    ANIMCMD_FRAME(0, 15),
...
static const union AnimCmd sAnim_GrowlitheHoenn_1[] =
{
    ANIMCMD_FRAME(0, 15),
    ANIMCMD_FRAME(1, 15),
    ANIMCMD_FRAME(0, 15),
...
static const union AnimCmd sAnim_ArcanineHoenn_1[] =
{
    ANIMCMD_FRAME(0, 15),
    ANIMCMD_FRAME(1, 15),
    ANIMCMD_FRAME(0, 15),
...
static const union AnimCmd sAnim_BagonHoenn_1[] =
{
    ANIMCMD_FRAME(0, 20),
    ANIMCMD_FRAME(1, 10),
    ANIMCMD_FRAME(0, 20),
...
static const union AnimCmd sAnim_PinsirHoenn_1[] =
{
    ANIMCMD_FRAME(0, 15),
    ANIMCMD_FRAME(1, 15),
    ANIMCMD_FRAME(0, 15),
...
static const union AnimCmd sAnim_GligarHoenn_1[] =
{
    ANIMCMD_FRAME(0, 15),
    ANIMCMD_FRAME(1, 15),
    ANIMCMD_FRAME(0, 15),
...
static const union AnimCmd sAnim_GliscorHoenn_1[] =
{
    ANIMCMD_FRAME(0, 15),
    ANIMCMD_FRAME(1, 15),
    ANIMCMD_FRAME(0, 15),
...
static const union AnimCmd sAnim_DeoxysHoenn_1[] =
{
    ANIMCMD_FRAME(0, 15),
    ANIMCMD_FRAME(1, 15),
    ANIMCMD_FRAME(0, 15),
...
SINGLE_ANIMATION(GligarHoenn);
SINGLE_ANIMATION(GliscorHoenn);
SINGLE_ANIMATION(DeoxysHoenn);
...
const union AnimCmd *const *const gMonFrontAnimsPtrTable[] =
{
    ...
    [SPECIES_GLIGAR_HOENN] = sAnims_GligarHoenn,
    [SPECIES_GLISCOR_HOENN] = sAnims_GliscorHoenn,
    [SPECIES_DEOXYS_HOENN] = sAnims_DeoxysHoenn,
