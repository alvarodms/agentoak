...
const u32 gMonStillFrontPic_StantlerHoenn[] = INCBIN_U32("graphics/pokemon/stantler_hoenn/front.4bpp.lz");
const u32 gMonPalette_StantlerHoenn[] = INCBIN_U32("graphics/pokemon/stantler_hoenn/normal.gbapal.lz");
const u32 gMonBackPic_StantlerHoenn[] = INCBIN_U32("graphics/pokemon/stantler_hoenn/back.4bpp.lz");
const u32 gMonShinyPalette_StantlerHoenn[] = INCBIN_U32("graphics/pokemon/stantler_hoenn/shiny.gbapal.lz");
...
const u32 gMonStillFrontPic_GliscorHoenn[] = INCBIN_U32("graphics/pokemon/gliscor_hoenn/front.4bpp.lz");
const u32 gMonPalette_GliscorHoenn[] = INCBIN_U32("graphics/pokemon/gliscor_hoenn/normal.gbapal.lz");
const u32 gMonBackPic_GliscorHoenn[] = INCBIN_U32("graphics/pokemon/gliscor_hoenn/back.4bpp.lz");
const u32 gMonShinyPalette_GliscorHoenn[] = INCBIN_U32("graphics/pokemon/gliscor_hoenn/shiny.gbapal.lz");
const u8 gMonIcon_GliscorHoenn[] = INCBIN_U8("graphics/pokemon/gliscor_hoenn/icon.4bpp");
const u8 gMonFootprint_GliscorHoenn[] = INCBIN_U8("graphics/pokemon/gliscor_hoenn/footprint.1bpp");
...
const u32 gMonShinyPalette_DeoxysHoenn[] = INCBIN_U32("graphics/pokemon/deoxys_hoenn/shiny.gbapal.lz");
const u8 gMonIcon_DeoxysHoenn[] = INCBIN_U8("graphics/pokemon/deoxys_hoenn/icon.4bpp");
const u8 gMonFootprint_DeoxysHoenn[] = INCBIN_U8("graphics/pokemon/deoxys_hoenn/footprint.1bpp");
