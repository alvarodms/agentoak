...
const u8 gText_MusicSpeed[] = _("MUSIC SPEED");
const u8 gText_MusicSpeed1x[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}1x");
const u8 gText_MusicSpeed2x[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}2x");
const u8 gText_MusicSpeed3x[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}3x");
const u8 gText_MusicSpeed4x[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}4x");
