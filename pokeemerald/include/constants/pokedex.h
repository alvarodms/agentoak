...
enum {
    ...
    // Old Unown    NATIONAL_DEX_DEOXYS_HOENN,
...
#define NATIONAL_DEX_COUNT  NATIONAL_DEX_GLISCOR_HOENN
...
enum {
    ...
    HOENN_DEX_GABITE,
    HOENN_DEX_GARCHOMP,
    HOENN_DEX_CORSOLA_HOENN,
    HOENN_DEX_GROWLITHE_HOENN,
    HOENN_DEX_ARCANINE_HOENN,
    HOENN_DEX_DUSKNOIR,
    HOENN_DEX_HONCHKROW,
    HOENN_DEX_FROSLASS,
    HOENN_DEX_MAMOSWINE,
    ...
    HOENN_DEX_FARIGIRAF,
    HOENN_DEX_PINSIR_HOENN,
    HOENN_DEX_STANTLER_HOENN,
    HOENN_DEX_DEOXYS_HOENN,
    HOENN_DEX_GLIGAR_HOENN,
    HOENN_DEX_GLISCOR_HOENN,
