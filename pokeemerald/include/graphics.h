...
extern const u32 gMonFrontPic_PinsirHoenn[];
extern const u32 gMonPalette_PinsirHoenn[];
extern const u32 gMonBackPic_PinsirHoenn[];
extern const u32 gMonShinyPalette_PinsirHoenn[];
extern const u32 gMonStillFrontPic_PinsirHoenn[];
extern const u8 gMonIcon_PinsirHoenn[];
extern const u8 gMonFootprint_PinsirHoenn[];
extern const u32 gMonFrontPic_StantlerHoenn[];
extern const u32 gMonPalette_StantlerHoenn[];
extern const u32 gMonBackPic_StantlerHoenn[];
extern const u32 gMonShinyPalette_StantlerHoenn[];
extern const u32 gMonStillFrontPic_StantlerHoenn[];
extern const u8 gMonIcon_StantlerHoenn[];
extern const u8 gMonFootprint_StantlerHoenn[];
extern const u32 gMonFrontPic_GligarHoenn[];
extern const u32 gMonPalette_GligarHoenn[];
extern const u32 gMonBackPic_GligarHoenn[];
extern const u32 gMonShinyPalette_GligarHoenn[];
extern const u32 gMonStillFrontPic_GligarHoenn[];
extern const u8 gMonIcon_GligarHoenn[];
extern const u8 gMonFootprint_GligarHoenn[];
extern const u32 gMonFrontPic_GliscorHoenn[];
extern const u32 gMonPalette_GliscorHoenn[];
extern const u32 gMonBackPic_GliscorHoenn[];
extern const u32 gMonShinyPalette_GliscorHoenn[];
extern const u32 gMonStillFrontPic_GliscorHoenn[];
extern const u8 gMonIcon_GliscorHoenn[];
extern const u8 gMonFootprint_GliscorHoenn[];
extern const u32 gMonFrontPic_DeoxysHoenn[];
extern const u32 gMonPalette_DeoxysHoenn[];
extern const u32 gMonBackPic_DeoxysHoenn[];
extern const u32 gMonShinyPalette_DeoxysHoenn[];
extern const u32 gMonStillFrontPic_DeoxysHoenn[];
extern const u8 gMonIcon_DeoxysHoenn[];
extern const u8 gMonFootprint_DeoxysHoenn[];
