...
- **The Sky Guardian** *(in progress)* — Resolving the Primal crisis triggers a new atmospheric anomaly. The Pacifidlog elder shares the Draconid legend of an ancient sky guardian, and Wallace unseals Sky Pillar. NPCs across Hoenn sense something stirring above the clouds. The trilogy's capstone — earth, sea, sky — awaits at the summit.
