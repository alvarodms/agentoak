...
| Wild Encounters | 3, 4, 9, 14, 21, 47, 49, 52, 63, 68, 86, 91, 92, 98, 99, 100, 121, 136, 165, 166, 167, **207**, **208** | 3 (JSON + C + flags) | [wild-encounters.md](completed-work/wild-encounters.md) |
| Trainer Parties | 6–12, 16, 17, 19, 49–58, 71–74, 89, 90, 94, 101, 102, 122–124, 126, 127, 130–133, 136, 146, 147, 148, 150, 172, 173, 175, 176, 177, 182, 203, 204, **206**, **212**, **213**, **214** | 6 (parties, trainers, opponents, battle_setup, flags, learnsets) | [trainer-parties.md](completed-work/trainer-parties.md) |
| NPC Dialogue (all regions + narrative) | 15, 24–29, 32, 33, 36, 38, 42, 50, 63, 65, 94, 95, 103, 104, 113, 116, 120, 125, 126, 135, 136, 137, 139, 140, 141, 142, 144, 145, 146, 149, 152, 153, 154, 159, 160, 161(reverted), 162, 180, 181, 183, 186, 187, 188, 189, 190, 192, 193, 194, 195, 200, 203, 204, 205, **207**, **208**, **209**, **210**, **213**, **214** | ~90 | [npc-dialogue.md](completed-work/npc-dialogue.md) |
...
| New Species | **60**, **61**, **68**, **70**, **195**, **198**, **208**, **212**, **213**, **214**, **216**, **217** | 29 source + 30+ assets | [new-species.md](completed-work/new-species.md) |
| Engineering Validation | 112, 118, 127, 141, 145, 170, 179, 185, 190, 192, 195, 202, **206** | Makefile + 6 scripts + event_macros.inc + legend_macros.inc + trainer audit + species pipeline | [engineering-validation.md](completed-work/engineering-validation.md) |
...
- **trainer_parties.h / trainers.h**: ~32 cycles each — all trainer data. Macro must match struct. C195 fixed 17 macro mismatches.
- **wild_encounters.json**: 24 cycles (last: C217) — all encounter tables
- **include/constants/flags.h**: Many cycles — custom flags through 0x29A (Deoxys quest C210), next: 0x29B
