...
| Wild Encounters | 3, 4, 9, 14, 21, 47, 49, 52, 63, 68, 86, 91, 92, 98, 99, 100, 121, 136, 165, 166, 167, **207**, **208**, **219** | 3 (JSON + C + flags) | [wild-encounters.md](completed-work/wild-encounters.md) |
| Trainer Parties | 6–12, 16, 17, 19, 49–58, 71–74, 89, 90, 94, 101, 102, 122–124, 126, 127, 130–133, 136, 146, 147, 148, 150, 172, 173, 175, 176, 177, 182, 203, 204, **206**, **212**, **213**, **214**, **218** | 6 (parties, trainers, opponents, battle_setup, flags, learnsets) | [trainer-parties.md](completed-work/trainer-parties.md) |
...
| New Species | **60**, **61**, **68**, **70**, **195**, **198**, **208**, **212**, **213**, **214**, **216**, **217**, **218**, **219**, **222** | 29 source + 30+ assets | [new-species.md](completed-work/new-species.md) |
| Engineering Validation | 112, 118, 127, 141, 145, 170, 179, 185, 190, 192, 195, 202, **206**, **220**, **222** | Makefile + 8 scripts + event_macros.inc + legend_macros.inc + trainer audit + species pipeline + gap-filler | [engineering-validation.md](completed-work/engineering-validation.md) |
...
- **wild_encounters.json**: 25 cycles (last: C219) — all encounter tables
- **include/constants/flags.h**: Many cycles — custom flags through 0x29B (Bagon callback C215), next: 0x29C
