...
| NPC Dialogue (all regions + narrative) | 15, 24–29, 32, 33, 36, 38, 42, 50, 63, 65, 94, 95, 103, 104, 113, 116, 120, 125, 126, 135, 136, 137, 139, 140, 141, 142, 144, 145, 146, 149, 152, 153, 154, 159, 160, 161(reverted), 162, 180, 181, 183, 186, 187, 188, **189** | ~80 | [npc-dialogue.md](completed-work/npc-dialogue.md) |
...
| Engineering Validation | 112, 118, 127, 141, 145, 170, 179, **185** | Makefile + 5 scripts + event_macros.inc + legend_macros.inc | [engineering-validation.md](completed-work/engineering-validation.md) |
...
- **MossdeepCity/scripts.inc**: 6 cycles (last: C186) — beast sightings, post-climax reactions, badge-conditional atmosphere
- **SootopolisCity/scripts.inc**: 4 cycles (last: C186) — Rayquaza reactions, badge-conditional atmosphere
- **PacifidlogTown/scripts.inc**: 7 cycles (last: C186) — Draconid legend, breadcrumbs, badge-conditional atmosphere
...
- **include/constants/flags.h**: Many cycles — custom flags through 0x289, next: 0x28A
