...
- **Armored cave bat v2** (Gliscor_Hoenn): Deep ocean blue body (5-85,32-135,75-188) — shifted from teal-grey to saturated aquatic blue per community feedback (#149). Aqua fin accents (42-170,82-215,120-242) replacing grey mineral — reads as "aquatic armor" not "rock armor." Tail: scorpion barb replaced with V-fork caudal fin (2 aqua lobes at idx 10/12, 5 rows below tail shaft). Anim frame 2 has different body pose — tail fin applied to frame 1 only (frame 2 tail not visible). Shiny: amber body + blue-patina stone accents (38-142,48-152,58-162) = "golden body with sea-tarnish."
