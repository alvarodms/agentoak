...
- **Crystal gecko line** (Treecko/Grovyle/Sceptile_Hoenn): Cool steel-blue body (42-162,52-178,78-208), pale crystal gleam highlights (198-210,215-225,245-248), deep violet prismatic accents (58-105,45-78,95-155). Amber eyes (185,150,65)/(228,205,110) for warm contrast against all-cool body. Crystal blade tails: dark→bright gradient (42-112,52-138,78-178). Edge emanation (3-5px) + interior gleam spots (4-6px). Shiny: warm gold-amber body (68-218,52-185,32-122) + cool blue eyes (65,135,185) for inverted contrast.
- **Starlight bird line** (Torchic/Combusken/Blaziken_Hoenn): Violet-gold celestial theme. Torchic: pale violet-white body (148-215,118-198,172-232), luminous gold crest (205-255,175-242,72-172), warm golden-white eyes, halo emanation (4px idx 15) above crest. Combusken: deeper violet body (92-162,52-108,112-182), pale gold wing feathers (168-248,142-238,82-178), wing-edge shimmer (3px). Blaziken: pale gold body (198-255,172-250,128-228), deep violet plumes (72-148,32-85,88-172), celestial blue eyes (168,198,248), aura emanation (6px idx 6). Icons: halo glow for Torchic (idx 3 above idx 5 crest). Shiny: inverted "Dawn Bird" = gold body + indigo accents (Torchic/Combusken) or sapphire plumes (Blaziken). Duplicate palette indices (1-3 and 11-13 in Torchic .pal) allow different crest vs beak coloring.
- **Tidal Monk line** (Mudkip/Marshtomp/Swampert_Hoenn): Shoal Cave slate-indigo theme. Primary body: deep slate (32-88,38-95,62-125), nearly equal RGB shifted toward blue. Headfin/tail accents: soft lavender (102-158,85-142,135-188) — bioluminescent, NOT neon. Belly/gills: warm brine-stone (85-178,82-175,72-165). Psychic emanation: 2-4 lavender idx pixels placed beyond headfin silhouette at tip. Marshtomp adds forearm lavender marks (body→lavender remap at arm edges). Swampert headcrest uses purple-shifted slate (68,62,98) + vivid lavender (138,102,168) emanation at crest tips. Shiny "Midnight Monk": charcoal body (25-78,22-72,28-82) + amber/gold psychic accents (148-215,118-182,45-82) — warm inversion of cool normal.
