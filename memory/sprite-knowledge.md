...
- **Armored cave bat** (Gliscor_Hoenn): Deep ocean teal body (8-45,42-108,68-142), mineral white-grey accents (72-205,78-215,85-225) replacing red pincers/claws — calcified armor from palette swap. Dark navy shadows (8-18,42-50,68). Wing membrane deposits: 9 idx 13→11 dark mineral pixels on wing edges (6 right, 3 left). Tail crystallization: 5 body→idx 12/10 bright mineral pixels at tail barb tip. Shiny: amber body (78-230,52-205,28-142) + dark stone accents (48-162,38-148,25-128) = "sunken amber" theme.
