...
**"The Gathering Storm" arc (v1.7)**: City atmosphere NPCs (C186) → ocean witnesses (C187) → Deep Migration R128 (C188) → The Gathering R126 (C189) → permanent fog + post-Gathering callbacks (C190). Victory Road redesigned (C175). E4 + Champion redesigned with cross-gen evos (C203-204, C212-218). **Drake's team now includes Bagon_Hoenn (Dragon/Rock, C268)** — replaces Altaria across all 5 teams. Rock Head + Double-Edge combo with Hard Stone-boosted Rock STAB. Narratively: the Dragon Master values native Hoenn dragons above foreign imports.
