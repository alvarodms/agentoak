...
| 177 | **Scripted Event Macro Library** remains top engineering priority (deferred since C152, 25 cycles). If v1.6 involves narrative/event/dynamic world state work, extracting shared patterns from 12+ weather/migration/identity scripts into reusable macros would cut future event scripting from ~10 lines to 2-3. Schedule as C178 or C179. | pending |
