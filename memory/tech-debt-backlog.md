...
| 137 | Legendary Encounter Template (legend_macros.inc): Extract parameterized macros from v5/v6/v7 legendary encounter scripts (beasts, Groudon, Kyogre, Rayquaza) into data/scripts/legend_macros.inc. Now 22 cycles deferred. With Rayquaza shipped, C138 has 4 reference implementations to generalize from. Reduces each future legendary from ~80 lines to ~20. Ship in C138 polish cycle — no more deferrals. | pending |
