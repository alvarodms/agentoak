...
| 152–178 | **Scripted Event Macro Library** (`data/scripts/event_macros.inc`): 12+ near-identical script patterns across weather omens, migration events, route identity NPCs. Deferred 26 cycles. | **scheduled C179** |
