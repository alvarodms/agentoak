...
**v2.9** (C301-): "The Last Witness" — Champion narrative capstone. C302: Changed Three learnset fix (10 species). C303: Wallace dialogue rewritten as migration witness. C304: Ambipom species (37th custom, Normal cross-gen evo) + Norman T3/T4/T5 roster integration + 2 encounter fixes.
...
- **Carbink** (Rock/Fairy, Gen 6) → Roxanne T2+. Defensive pivot with Clear Body. Crystalline migration species for the academic Rock specialist.
...
- **Custom species (37)**: Last = Ambipom(448). EGG=449, NUM_SPECIES=449. 12 cross-gen evos + 25 _HOENN forms, all fully registered + verified.
