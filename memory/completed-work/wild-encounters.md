...
| `src/data/wild_encounters.json` | Early Game Reset: R101-104 + Petalburg Woods (5 land tables + R102 water) | **164** | v1.4 Cycle A. Removed all pseudo-legendaries from pre-Badge 1 routes. Restored Hoenn identity (Zigzagoon/Poochyena/Wurmple/Taillow core). Added curated 1% rewards: Eevee (R101), Abra (R102), Staryu (R103), Pikachu (R104), Heracross (Petalburg Woods). R102 water: Dratini→Marill/Goldeen. Issue #82 addressed. |
