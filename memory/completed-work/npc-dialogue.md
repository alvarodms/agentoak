...
- **Migration Glimpse Events** (C144): 2 scripted coord_event atmospheric encounters on Route 101 and Route 104. Player walks through trigger tiles post-Pokédex, gets exclamation mark + 2-part mystery text. Gated on FLAG_ADVENTURE_STARTED, one-shot via FLAG_MIGRATION_GLIMPSE_ROUTE101 (0x278) / FLAG_MIGRATION_GLIMPSE_ROUTE104 (0x279). Files: Route101/scripts.inc, Route101/map.json, Route104/scripts.inc, Route104/map.json, include/constants/flags.h.
