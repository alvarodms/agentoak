...
- **Weather Omen NPCs** (C159): Route 111 Hiker (post-Badge 5 permanent sandstorm reaction, flag 0x282) and Route 119 Ranger (post-Badge 6 permanent thunderstorm reaction, flag 0x283). Both gated via HIDE flags, shown in OnTransition when badge earned. Route 111 sandstorm logic modified to bypass coordinate checks post-Badge 5. Route 119 weather overridden from cycling rain to permanent thunderstorm post-Badge 6.
