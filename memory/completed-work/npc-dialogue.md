...
- **v1.8 Quest 2 Implementation** (C194): "Hartley's Field Report" — 3 weather-site field checks with emotionally distinct dialogue + Hartley return synthesis. Route111: Hiker quest branching (resignation — "the desert won"), sets FLAG_QUEST_HARTLEY_SITE1. Route119: Ranger quest branching (wonder — new species calls, adapting life), sets FLAG_QUEST_HARTLEY_SITE2. Route125: Swimmer quest branching (unease — pulsing hail, wrong kind of cold), sets FLAG_QUEST_HARTLEY_SITE3. WeatherInstitute2F: Reminder script → progress check (all 3 sites), return handler with weather-divergence synthesis ("HOENN isn't recovering. It's adapting.") + ITEM_NEVER_MELT_ICE reward + FLAG_QUEST_HARTLEY_COMPLETE. Updated post-completion text. Files: Route111/scripts.inc, Route119/scripts.inc, Route125/scripts.inc, Route119_WeatherInstitute_2F/scripts.inc.
