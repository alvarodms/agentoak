...
- **Route Identity NPCs** (C161): Route 110 Birdwatcher (OBJ_EVENT_GFX_MAN_3, x12/y60, LOOK_AROUND) — reports Taillow/Wingull migration patterns and possible Vulpix sighting. Route 113 Volcanologist (OBJ_EVENT_GFX_SCIENTIST_1, x28/y8, LOOK_AROUND) — reports 40% ash increase, unknown seismic activity, connects volcanism to migration. Both always-visible, no flags.
